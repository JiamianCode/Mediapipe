...
// 在control中已经定义过了videoContainer,后续可以优化
...
function updateCanvasContext(results){
    ...
    outputCanvas.width = videoContainer2.offsetWidth;
    outputCanvas.height = videoContainer2.offsetWidth * inputVideo.videoHeight / inputVideo.videoWidth;
